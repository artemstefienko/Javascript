...
let i12 = document.querySelector(".i-12_1");
let i12_1 = document.querySelector(".i-12_2");
let out12 = document.querySelector(".out-12");
function t12() {
  // console.log(i12.value);
  // console.log(i12_1.value);
  out12.textContent = "Hello" + i12.value + " " + i12_1.value;
}
...
function t13() {
  let i13 = +document.querySelector(".i-13_1").value;
  let i13_1 = +document.querySelector(".i-13_2").value;
  let out13 = document.querySelector(".out-13");
  out13.textContent = i13 + i13_1;
}
...
let i16 = document.querySelector(".i-16_1");
let i16_1 = document.querySelector(".i-16_2");
let out16 = document.querySelector(".out-16");
function t16() {
  out16.textContent = +i16.value + +i16_1.value;
}
...
let i19 = document.querySelector(".i-19_1");
let i19_1 = document.querySelector(".i-19_2");
let out19 = document.querySelector(".out-19");
function t19() {
  let val19 = parseInt(i19.value);
  let val19_1 = parseInt(i19_1.value);
  out19.textContent = val19 + val19_1;
}
...
let i20 = document.querySelector(".i-20"); // Имя
let i20_1 = document.querySelector(".i-20_1"); //фамилия
let i20_2 = document.querySelector(".i-20_2"); //Возраст
let i20_3 = document.querySelector(".i-20_3"); //Род занятости
