...
document.querySelector(".three").innerHTML = "<h3>h3text</h3>";
// Task 11.
...
document.querySelector(".four").innerHTML = "<h4>h4произвольным текстом</h4>";
document.querySelector(".four").innerHTML = "<p> p произвольным текстом</p>";
// Task 12.
...
div7.innerHTML =
  '<img src="https://cdn4.iconfinder.com/data/icons/food-and-drink-flat-gradient/32/cone_ice_cream_food_drink_sweet-512.png" alt="" ></img>';
//  Task 14.
